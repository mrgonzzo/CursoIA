...
#phillips_trabajando = phillips[phillips['inlf'] == 1].copy()
...
# Supongamos que tienes un DataFrame df con las variables
# Y: variable dependiente
# X1, X2, X3, etc.: variables independientes

# Seleccionamos las variables independientes
X = phillips[['unem', 'year']]  # <-- reemplaza por tus variables
y = phillips['inf']

# Opcional: Añadir constante para el modelo MCO
...
# 📊 Calcular matriz de correlación entre variables independientes
...
#
phillips = phillips.rename(columns={"year": "anio"})  # por ejemplo
phillips = phillips.rename(columns={"inf": "inflacion"})
# MODELO 2: Sin término cuadrático
print("\n\n🔹 MODELO 2: Sin educación al cuadrado")
mod2 = ols('inflacion ~ unem + anio',
           data=phillips).fit()
