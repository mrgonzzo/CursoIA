...
#hprice1_trabajando = hprice1[hprice1['inlf'] == 1].copy()

print("\n" + "=" * 70)
print("EJERCICIO: Determinantes del precio")
print("=" * 70)

# MODELO 1: Con término cuadrático
#print("\n🔹 MODELO 1: Incluyendo educación al cuadrado")
#mod1 = ols('lwage ~ nwifeinc + bdrms',
#           data=hprice1_trabajando).fit()
#informe_modelo_simple(mod1, "Modelo con educ²")

# MODELO 2: Sin término cuadrático
print("\n\n🔹 MODELO 2: Sin término cuadrático")
mod2 = ols('price ~ lotsize + sqrft +bdrms',
           data=hprice1).fit()
