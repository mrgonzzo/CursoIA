...
# Relación verdadera (poblacional)
precio_real = (20000 + 
              300 * ingresos/1000 + 
              1500 * experiencia + 
              800 * educacion + 
...
# 3. MODELO DE MÍNIMOS CUADRADOS ORDINARIOS MÚLTIPLE
...
# Modelo con statsmodels (más detalle estadístico)
...
# 6. COMPARACIÓN VISUAL: VALORES REALES vs PREDICHOS
...
# Recalcular métricas con outlier
...
print("\n" + "="*60)
print("CONCLUSIÓN: El RECM es más sensible a outliers que el EMA")
print("debido a la penalización cuadrática de errores grandes.")
print("="*60)